...
protected:
    void SetUp() override {
        analyzer = std::make_unique<asuka1975::SequenceAnalyzer<char, char, Error>>(std::make_unique<SimpleRule_0SeekBack>());
    }

    std::unique_ptr<asuka1975::SequenceAnalyzer<char, char, Error>> analyzer;
};
